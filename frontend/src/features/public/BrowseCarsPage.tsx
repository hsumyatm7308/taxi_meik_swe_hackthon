  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-muted-foreground mb-6">Browse verified cars for rent across Myanmar</p>
        ...
        {showFilters && (
          <motion.div
            ...
            className="flex flex-wrap gap-3 mb-6 p-4 rounded-xl border bg-card"
          >

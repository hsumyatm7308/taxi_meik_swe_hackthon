  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto text-center mb-16">
        <h1 className="text-4xl font-bold mb-4">About TaxiRental Myanmar</h1>
        <p className="text-lg text-muted-foreground">Building Myanmar's most trusted taxi rental ecosystem</p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            TaxiRental Myanmar connects car owners with verified taxi drivers through a secure, transparent platform. We solve the trust problem in car rentals by implementing thorough verification, secure deposit handling, and fair dispute resolution.
          </p>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          { icon: <Shield className="w-6 h-6" />, title: 'Trust & Safety', desc: 'Every user is verified, every car is inspected, every transaction is protected.' },

...
export const paymentUploadDir = path.resolve(__dirname, "../../uploads/payments");
...
export function uploadPaymentScreenshot(req: Request, res: Response, next: NextFunction) {
